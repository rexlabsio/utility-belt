...
class ObjectUtility
{
     ...
     * @param \stdClass|array|string $object            An object the either extends ArrayObject or provides any of the
     *                                                  following methods: getArrayCopy toArray getArray getAsArray
     * @param callable               $uncastable_caster (optional) A callback to use to cast a value if it otherwise
     *                                                  couldn't be cast. If not provided and an unprocessable object
     *                                                  is provided an \InvalidArgumentException will be thrown. If the
     *                                                  callback does not return an array an InvalidArgumentException
     *                                                  will be thrown
